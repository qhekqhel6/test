...
unit_x_pos = 5 + unit_width
unit_y_pos = 5 + unit_height

# 적 캐릭터 (떨어지는 똥)
unit_1 = pygame.image.load("C:/Users/user/Desktop/pygame_basic/pyimg/center.png")
unit_1_size = unit_1.get_rect().size #이미지의 크기를 구해옴
unit_1_width = unit_1_size[0]
unit_1_height = unit_1_size[1]
unit_1_x_pos = screen_width / 2 - unit_width / 2
