...
# 배경 이미지 불러오기
background = pygame.image.load("C:/Users/user/Desktop/pygame_basic/pyimg/paper_background.jpg")
...
# 적 캐릭터 (떨어지는 똥)
unit_1 = pygame.image.load("C:/Users/user/Desktop/pygame_basic/pyimg/ddong.png")
unit_1_size = unit_1.get_rect().size #이미지의 크기를 구해옴
unit_1_width = unit_1_size[0]
unit_1_height = unit_1_size[1]
unit_1_x_pos = random.randint(0, screen_width - unit_1_width)
unit_1_y_pos = 0

unit_2 = pygame.image.load("C:/Users/user/Desktop/pygame_basic/pyimg/ddong.png")
unit_2_size = unit_2.get_rect().size #이미지의 크기를 구해옴
unit_2_width = unit_2_size[0]
unit_2_height = unit_2_size[1]
unit_2_x_pos = random.randint(0, screen_width - unit_1_width)
unit_2_y_pos = 0
...
while running:
    ...
    unit_x_pos += xpos
    unit_y_pos += ypos
    unit_1_y_pos += unit_speed * 2
    unit_2_y_pos += unit_speed * 2
    ...
    if unit_1_y_pos > screen_height:
        unit_1_y_pos = 0
        unit_1_x_pos = random.randint(0, screen_width - unit_1_width)
    
    if unit_2_y_pos > screen_height:
        unit_2_y_pos = 0
        unit_2_x_pos = random.randint(0, screen_width - unit_2_width)
    ...
    unit_2_rect = unit_2.get_rect()
    unit_2_rect.left = unit_2_x_pos
    unit_2_rect.top = unit_2_y_pos
    ...
    if unit_rect.colliderect(unit_2_rect):
        print("충돌")
        running = False
    ...
    screen.blit(unit_2, (unit_2_x_pos, unit_2_y_pos))
    #for unit_1 in units:
