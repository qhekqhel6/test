from PySide2.QtWidgets import QApplication, QGraphicsView, QGraphicsScene, QGraphicsEllipseItem, QWidget, QLabel, QHBoxLayout, QPushButton
from PySide2 import QtCore, QtGui
from PySide2.QtCore import Qt, QPointF
from PySide2.QtGui import QVector3D, QQuaternion, QPainter, QRegion
import sys
...
class Camera:
    ...
    def move_forward(self):
        self.position += self.forward_vector * self.speed # 앞
        
    def move_backward(self):
        self.position -= self.forward_vector * self.speed # 뒤
        
    def move_right(self):
        self.position += self.right_vector * self.speed   # 우
        
    def move_left(self):
        self.position -= self.right_vector * self.speed   # 좌
        
    def move_up(self):
        self.position += self.up_vector * self.speed      # 상
        
    def move_down(self):
        self.position -= self.up_vector * self.speed      # 하
